...
def download_ljspeech(path: str, url):
...
if __name__ == "__main__":
  ...
  download_ljspeech(directory, "https://data.keithito.com/data/speech/LJSpeech-1.1.tar.bz2")
  #download_ljspeech(directory, "https://data.solak.de/data/Training/stt_tts/en_US.tgz")
